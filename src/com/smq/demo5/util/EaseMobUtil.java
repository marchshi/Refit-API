...
public class EaseMobUtil {
     ...
     */
    static {
        InputStream inputStream = EaseMobUtil.class.getClassLoader().getResourceAsStream("config.properties");
    ...
    public static String getOrgAppUserName(){
    	return "/"+ORG_NAME+"/"+APP_NAME+"/users";
    }
